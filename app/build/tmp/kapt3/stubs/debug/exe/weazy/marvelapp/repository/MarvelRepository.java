...
public final class MarvelRepository {
    ...
    @org.jetbrains.annotations.NotNull()
    public final io.reactivex.Observable<java.util.List<exe.weazy.marvelapp.model.Character>> fetchCharactersFromNetwork(int offset, int limit) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.paging.DataSource.Factory<java.lang.Integer, exe.weazy.marvelapp.model.Character> getCacheDataSource() {
        return null;
    }
    
    public final void writeCharactersToCache(@org.jetbrains.annotations.NotNull()
    java.util.List<exe.weazy.marvelapp.model.Character> characters) {
    }
    
    public final void eraseAllCharactersFromCache() {
    }
